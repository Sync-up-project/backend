  ...
  const users = await Promise.all([
    ...
    prisma.user.create({
      data: {
        ...
        role: UserRole.DEV,
        primaryLanguage: Language.EN,
        bio: "React/TypeScript 프론트엔드 개발자입니다.",
        githubUsername: "reactranger",
        githubUrl: "https://github.com/reactranger",
        githubCommits: 420,
        githubRepoCount: 22,
      },
    }),
    prisma.user.create({
      data: {
        ...
        role: UserRole.DEV,
        primaryLanguage: Language.KO,
        bio: "Node.js/NestJS 백엔드 개발자입니다.",
        githubUsername: "nodepilot",
        githubUrl: "https://github.com/nodepilot",
        githubCommits: 380,
        githubRepoCount: 19,
      },
    }),
    prisma.user.create({
      data: {
        ...
        role: UserRole.DEV,
        primaryLanguage: Language.KO,
        bio: "DB 모델링과 API 최적화를 좋아합니다.",
        githubUsername: "datamason",
        githubUrl: "https://github.com/datamason",
        githubCommits: 260,
        githubRepoCount: 14,
      },
    }),
    prisma.user.create({
      data: {
        ...
        passwordHash,
        nickname: "CloudHarbor",
        role: UserRole.DEV,
        primaryLanguage: Language.EN,
        bio: "클라우드 인프라와 배포 자동화 담당.",
        githubUsername: "cloudharbor",
        githubUrl: "https://github.com/cloudharbor",
        githubCommits: 310,
        githubRepoCount: 17,
      },
    }),
    prisma.user.create({
      data: {
        ...
        passwordHash,
        nickname: "MobileForge",
        role: UserRole.DEV,
        primaryLanguage: Language.KO,
        bio: "Flutter 기반 앱 개발을 주로 합니다.",
        githubUsername: "mobileforge",
        githubUrl: "https://github.com/mobileforge",
        githubCommits: 205,
        githubRepoCount: 11,
      },
    }),
    prisma.user.create({
      data: {
        ...
        role: UserRole.DEV,
        primaryLanguage: Language.EN,
        bio: "iOS 앱과 디자인 시스템 연결 경험이 많습니다.",
        githubUsername: "swiftwave",
        githubUrl: "https://github.com/swiftwave",
        githubCommits: 188,
        githubRepoCount: 9,
      },
    }),
    prisma.user.create({
      data: {
        ...
        role: UserRole.PLANNER,
        primaryLanguage: Language.KO,
        bio: "서비스 전략과 요구사항 정의를 담당합니다.",
        githubUsername: "ideaanchor",
        githubUrl: "https://github.com/ideaanchor",
        githubCommits: 96,
        githubRepoCount: 7,
      },
    }),
    prisma.user.create({
      data: {
        ...
        role: UserRole.PLANNER,
        primaryLanguage: Language.KO,
        bio: "로드맵 수립과 팀 커뮤니케이션을 돕습니다.",
        githubUsername: "roadmaplee",
        githubUrl: "https://github.com/roadmaplee",
        githubCommits: 120,
        githubRepoCount: 10,
      },
    }),
    prisma.user.create({
      data: {
        ...
        passwordHash,
        nickname: "ScopeKeeper",
        role: UserRole.PLANNER,
        primaryLanguage: Language.EN,
        bio: "범위 관리와 일정 조율 중심의 PM입니다.",
        githubUsername: "scopekeeper",
        githubUrl: "https://github.com/scopekeeper",
        githubCommits: 76,
        githubRepoCount: 6,
      },
    }),
    prisma.user.create({
      data: {
        ...
        role: UserRole.DESIGN,
        primaryLanguage: Language.KO,
        bio: "모바일 UX와 프로토타입 제작을 좋아합니다.",
        githubUsername: "pixelmina",
        githubUrl: "https://github.com/pixelmina",
        githubCommits: 72,
        githubRepoCount: 8,
      },
    }),
    prisma.user.create({
      data: {
        email: "design3@example.com",
        passwordHash,
        nickname: "UXHana",
        role: UserRole.DESIGN,
        primaryLanguage: Language.EN,
        bio: "유저 리서치와 인터랙션 디자인 중심.",
        githubUsername: "uxhana",
        githubUrl: "https://github.com/uxhana",
        githubCommits: 61,
        githubRepoCount: 5,
      },
    }),
    prisma.user.create({
      data: {
        email: "design4@example.com",
        passwordHash,
        nickname: "FlowCanvas",
        role: UserRole.DESIGN,
        primaryLanguage: Language.KO,
        bio: "디자인 시스템 구축 경험이 많습니다.",
        githubUsername: "flowcanvas",
        githubUrl: "https://github.com/flowcanvas",
        githubCommits: 84,
        githubRepoCount: 9,
      },
    }),
    prisma.user.create({
      data: {
        ...
        role: UserRole.DEV,
        primaryLanguage: Language.EN,
        bio: "LLM 연동과 데이터 파이프라인 개발 담당.",
        githubUsername: "aipipeline",
        githubUrl: "https://github.com/aipipeline",
        githubCommits: 540,
        githubRepoCount: 28,
      },
    }),
    prisma.user.create({
      data: {
        ...
        passwordHash,
        nickname: "TestCrafter",
        role: UserRole.DEV,
        primaryLanguage: Language.KO,
        bio: "테스트 자동화와 품질 개선에 집중합니다.",
        githubUsername: "testcrafter",
        githubUrl: "https://github.com/testcrafter",
        githubCommits: 295,
        githubRepoCount: 16,
      },
    }),
